return {
	...
	whitelist = {
		...
		"^/try/[0-9a-zA-z-_]+/preview$",
		"^/lessonplan/[0-9a-zA-z-_]+/fill$",
	...
	upload_config = {
		dir = "./app/static/image", -- 文件目录，修改此值时须同时修改nginx配置文件中的$static_files_path值
	},	
