        	...
        	$.ajax({
	            ...
	            success : function(result) {
	                if(result.success){
	                    ...
	                    $("#comments-body").html('<div class="alert alert-info" role="alert">'+result.msg+'</div>');
	                }
	            },
	            error : function() {
	                $("#comments-body").html('<div class="alert alert-info" role="alert">发送请求失败.</div>');
	            }
	        });
        },
				...
				$.fn.jpagebar({
					...
					onClickPage : function(pageNo) {
						...
						$.ajax({
							...
							error : function() {
								 $("#comments-body").html('<div class="alert alert-info" role="alert">发送查找评论请求失败.</div>');
				            }
						});
					}
				});
