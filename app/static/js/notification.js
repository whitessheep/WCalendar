        	...
        	$.ajax({
	            ...
	            success : function(result) {
	                if(result.success){
	                    ...
	                    $("#notifications-body").html('<div class="alert alert-info" role="alert">'+result.msg+'</div>');
	                }
	            },
	            error : function() {
	                $("#notifications-body").html('<div class="alert alert-info" role="alert">查询通知请求发生错误.</div>');
	            }
	        });
        },
				...
				$.fn.jpagebar({
					...
					onClickPage : function(pageNo) {
						...
						$.ajax({
							...
							error : function() {
								 $("#notifications-body").html('<div class="alert alert-info" role="alert">查找通知请求发生错误.</div>');
				            }
						});
					}
				});
